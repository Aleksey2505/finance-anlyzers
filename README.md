...
### На этом проекте я:
- Прокачал понимание cash flow, структуры расходов и бюджетных правил  
- Создал кейс для финтеха и банков  
...
### На этом кейсе я понял и показал:
- Персонал — одна из самых больших статей расходов  
- Показал умение работать с затратами на персонал и строить управленческие дашборды  
